...
var KTModalCreateProjectSettings = (function () {
    ...
    var initForm = function () {
        ...
        var myDropzone = new Dropzone(
            "#kt_modal_create_project_settings_logo",
            {
                url: "https://www.instagram.com/bagelenbythefitriacookeryscripts/void.php", // Set the url for your upload script location
        ...
        var releaseDate = $(
            form.querySelector('[name="settings_release_date"]')
        );
