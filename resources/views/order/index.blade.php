...
@section('subtitle' , $subtitle ?? 'Order')
@section('head')
@endsection

@section('script')
@include('order.datatable.script')
@endsection
    ...
    <div id="kt_content_container" class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-toolbar">
                ...
                <div class="card-toolbar">
                    <!--begin::Toolbar-->
                    <div class="d-flex justify-content-end gap-3 me-lg-5" data-kt-user-table-toolbar="base">
            ...
            <div class="card-body py-4">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_order">
                    <thead>
