        ...
        <div class="row">
            ...
            <div class="form-group col-md-6 fv-row mb-3">
                ...
                <div class="position-relative mb-3">
                    <input type="number" name="no_whatsapp" class="form-control form-control-lg form-control-solid"
                        autocomplete="off" value="{{ isset($data) ? $data->no_whatsapp : '' }}" placeholder="Input WhatsApp Number" />
                    @error('no_whatsapp')
                        <p style="font-size: 12px;" class="mb-0 text-danger mt-1 font-italic font-weight-bold">{{ $message }} !</p>
                    @enderror
                </div>
            ...
            <div class="form-group col-md-6 fv-row mb-3">
                ...
                <div class="position-relative mb-3">
                    ...
                    value="{{ isset($data) ? $data->total_qty : '' }}" placeholder="Input Total Quantity" />
                    @error('total_qty')
                        <p style="font-size: 12px;" class="mb-0 text-danger mt-1 font-italic font-weight-bold">{{ $message }} !</p>
                    @enderror
                </div>
            ...
            <div class="form-group col-md-6 fv-row mb-3">
                ...
                <div class="position-relative mb-3">
                    ...
                    value="{{ isset($data) ? $data->total_price : '' }}" placeholder="Input Total Price" />
                    @error('total_price')
                        <p style="font-size: 12px;" class="mb-0 text-danger mt-1 font-italic font-weight-bold">{{ $message }} !</p>
                    @enderror
                </div>
            ...
            <!-- Proof of Transfer Input -->
            <div class="form-group col-md-12 fv-row mb-3">
                <label role="proof_transfer" class="form-label fw-bolder text-dark fs-6">Bukti Transfer</label>
                <div class="position-relative mb-3">
                    <input type="file" name="proof_transfer" class="form-control form-control-lg form-control-solid"
            ...
            <div class="form-group col-md-12 fv-row mb-3">
                ...
                <div class="position-relative mb-3">
                    <textarea name="address" class="form-control form-control-lg form-control-solid" rows="4" placeholder="Input Address">{{ isset($data) ? $data->address : old('address') }}</textarea>
                    @error('address')
                        <p style="font-size: 12px;" class="mb-0 text-danger mt-1 font-italic font-weight-bold">{{ $message }} !</p>
                    @enderror
                </div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-6 fv-row mb-3">
                ...
                <div class="position-relative mb-3">
                    <select name="shipping" id="shipping" class="form-control form-control-lg form-control-solid">
            ...
            <div class="form-group col-md-6 fv-row mb-3">
                ...
                <div class="position-relative mb-3">
                    <input type="number" name="shipping_price" class="form-control form-control-lg form-control-solid"
                        value="{{ isset($data) ? $data->shipping_price : '' }}" placeholder="Input Shipping Price" />
            ...
            <div class="form-group col-md-6 fv-row mb-3">
                ...
                <div class="position-relative mb-3">
                    <input type="text" name="shipping_code" class="form-control form-control-lg form-control-solid"
                        value="{{ isset($data) ? $data->shipping_code : '' }}" placeholder="Input Shipping Code" />
                    @error('shipping_code')
                        <p style="font-size: 12px;" class="mb-0 text-danger mt-1 font-italic font-weight-bold">{{ $message }} !</p>
                    @enderror
                </div>
