                        ...
                        render: function(data, type, row) {
                            ...
                            switch (data) {
                                ...
                                case 'DIKIRIM':
                                    ...
                                    break;
                                default:
                                    statusClass = 'bg-secondary text-white'; // Default class if needed
                            }
                        ...
                        render: function(data, type, row) {
                            return `
                                <div class="d-flex justify-content-between">
                                    <a href="/orders/detail/${row.id}" class="btn btn-sm btn-secondary p-3 m-1">
                                    ...
                                    <a href="/orders/edit/${row.id}" class="btn btn-sm btn-success p-3 m-1">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
