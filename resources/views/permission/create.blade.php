...
@section('subtitle' , 'Tambah Data Permission')
@section('head')
...
<div class="post d-flex flex-column-fluid" id="kt_post">
    ...
    <div id="kt_content_container" class="container-fluid">
        ...
        <div class="card">
            ...
            <!--end::Card header-->
            <!--begin::Card body-->
            <form method="POST" action="{{ route('permissions.store') }}" class="needs-validation" enctype="multipart/form-data" id="xss-validation">
                @csrf
                @include($view.'field')
            </form>
            <!--end::Card body-->
