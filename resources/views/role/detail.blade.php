                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <div class="mb-1">
                                <!--begin::Label-->
                                <label for="guard_name" class="form-label fw-bolder text-dark fs-6">Nama Penjaga
                                </label>
                                <!--end::Label-->
                                <!--begin::Input wrapper-->
                                <div class="position-relative mb-3">
                                    <input type="text" name="guard_name" class="form-control form-control-lg form-control-solid" autocomplete="off" value="{{ isset($data) ? $data->guard_name : '' }}" readonly/>
                                    @error('guard_name')
                                    <p style="font-size: 12px;" class="mb-0 text-danger mt-1 font-italic font-weight-bold">{{$message}} !</p>
                                    @enderror
                                </div>
